...
public class TokenRequestValidation_PKCE
{
    ...
    public async Task valid_pkce_token_request_with_plain_method_should_succeed(string clientId)
    {
        ...
        var parameters = new NameValueCollection
        {
            ...
            { OidcConstants.TokenRequest.CodeVerifier, verifier },
    ...
    public async Task token_request_with_missing_code_challenge_should_fail(string clientId)
    {
        ...
        var parameters = new NameValueCollection
        {
            { OidcConstants.TokenRequest.GrantType, OidcConstants.GrantTypes.AuthorizationCode },
            { OidcConstants.TokenRequest.Code, handle },
            { OidcConstants.TokenRequest.CodeVerifier, "x".Repeat(lengths.CodeVerifierMinLength) },
            { OidcConstants.TokenRequest.RedirectUri, "https://server/cb" }
        };
    ...
    public async Task token_request_with_invalid_verifier_plain_method_should_fail(string clientId)
    {
        ...
        var parameters = new NameValueCollection
        {
            { OidcConstants.TokenRequest.GrantType, OidcConstants.GrantTypes.AuthorizationCode },
            { OidcConstants.TokenRequest.Code, handle },
            { OidcConstants.TokenRequest.CodeVerifier, verifier + "invalid" },
            { OidcConstants.TokenRequest.RedirectUri, "https://server/cb" }
        };
