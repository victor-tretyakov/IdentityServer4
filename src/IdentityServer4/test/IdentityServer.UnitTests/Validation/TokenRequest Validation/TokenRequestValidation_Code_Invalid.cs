...
public class TokenRequestValidation_Code_Invalid
{
    ...
    public async Task Invalid_AuthorizationCode()
    {
        ...
        {
            { OidcConstants.TokenRequest.GrantType, OidcConstants.GrantTypes.AuthorizationCode },
            { OidcConstants.TokenRequest.Code, "invalid" },
            { OidcConstants.TokenRequest.RedirectUri, "https://server/cb" }
        };
    ...
    public async Task AuthorizationCodeTooLong()
    {
        ...
        {
            { OidcConstants.TokenRequest.GrantType, OidcConstants.GrantTypes.AuthorizationCode },
            { OidcConstants.TokenRequest.Code, longCode },
            { OidcConstants.TokenRequest.RedirectUri, "https://server/cb" }
        };
    ...
    public async Task Different_RedirectUri_Between_Authorize_And_Token_Request()
    {
        ...
        var parameters = new NameValueCollection
        {
            { OidcConstants.TokenRequest.GrantType, OidcConstants.GrantTypes.AuthorizationCode },
            { OidcConstants.TokenRequest.Code, handle },
            { OidcConstants.TokenRequest.RedirectUri, "https://server2/cb" }
        };
    ...
    public async Task Invalid_resource_indicator()
    {
        ...
        var parameters = new NameValueCollection
        {
            ...
            { OidcConstants.TokenRequest.Code, handle },
            { OidcConstants.TokenRequest.RedirectUri, "https://server/cb" },
            { OidcConstants.TokenRequest.Resource, "urn:api1" + new string('x', 512) }
        };
