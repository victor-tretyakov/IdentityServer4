...
{
    private readonly StubEndSessionRequestValidator _stubEndSessionRequestValidator = new StubEndSessionRequestValidator();
    private readonly EndSessionCallbackEndpoint _subject;
