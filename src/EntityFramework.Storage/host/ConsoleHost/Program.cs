...
class Program
{
    ...
    {
        var connectionString = "server=(localdb)\\mssqllocaldb;database=IdentityServer4.EntityFramework-7.0.0;trusted_connection=yes;";
        ...
        using (var scope = sp.CreateScope())
        {
            ...
            svc.CleanupGrantsAsync().GetAwaiter().GetResult();
        }
    }
}
