...
public class PersistedGrantStore : IPersistedGrantStore
{
    ...
    /// <inheritdoc/>
    public virtual async Task StoreAsync(Models.PersistedGrant token)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<Models.PersistedGrant> GetAsync(string key)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<IEnumerable<Models.PersistedGrant>> GetAllAsync(PersistedGrantFilter filter)
    {
        filter.Validate();
